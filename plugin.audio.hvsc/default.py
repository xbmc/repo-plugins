...
def init_addon():
	...
	pathtemp = xbmc.translatePath(os.path.join('special://profile/addon_data/plugin.audio.hvsc/' , 'temp'))
	files = os.listdir(pathtemp)
	for file in files:
		delfile = xbmc.translatePath(os.path.join('special://profile/addon_data/plugin.audio.hvsc/temp', file))
		os.unlink(delfile)
