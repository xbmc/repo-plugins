#!/usr/bin/python
# -*- coding: utf-8 -*-
import urllib,urllib2,re,xbmcplugin,xbmcgui,sys,xbmcaddon,socket,os
...
def playVideo(url):
          ...
          if len(match)>0:
            listitem = xbmcgui.ListItem(path="http://video.euronews.com/"+match[0]+".flv")
            return xbmcplugin.setResolvedUrl(pluginhandle, True, listitem)
          #else:
          #  xbmc.executebuiltin('XBMC.Notification(Info:,'+translation(30005)+',3000)')
