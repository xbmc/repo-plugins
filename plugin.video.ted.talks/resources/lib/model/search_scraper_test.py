...
class TestSearchScraper(unittest.TestCase):
    ...
    def test_get_talks_for_search_smoke(self):
        ...
        self.assertEqual('https://tedcdnpi-a.akamaihd.net/r/tedcdnpe-a.akamaihd.net/images/ted/a39d3332aa3d0cabe2e4c20ffb1a3934c012ee8b_1600x1200.jpg?', sample_talk[2])
