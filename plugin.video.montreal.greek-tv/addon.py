...
def main_menu():
    ...
    xml = client.request('http://www.greekradio.net/mgtv.xml')
    ...
    li = xbmcgui.ListItem(label=mgtv)
    ...
    li = xbmcgui.ListItem(label='Montreal Greek TV - Youtube Channel')
