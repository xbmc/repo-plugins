...
class itvrs_radio_ice(object):
  ...
  def __init__(self):
    ...
    li = nw.createListItem(nw.addonName, thumbnailImage = '{0}/resources/icon.png'.format(os.path.dirname(os.path.abspath(__file__))), streamtype = 'music', infolabels = { 'title' : nw.addonName })
