...
def get_category_fanthumb(name,catfa):
	if catfa=="Thumbnail":
		dimg = get_image_path(xbmc.translatePath( os.path.join( addonpath, 'resources', 'images', 'icons', 'categories' ) ))
	else:
		dimg = get_fimage_path(xbmc.translatePath( os.path.join( addonsavepath, 'fanart', 'categories' ) ))
	noimg = get_image_path(xbmc.translatePath( os.path.join( addonpath, 'resources', 'images', 'icons', 'default' ) ))
	# Main Categories
	...
	# Browse By System
		...
		thumbnail = xbmc.translatePath(os.path.join(dimg, "wii.png"))
	elif name=="MSX Home Computer System":
		thumbnail = xbmc.translatePath(os.path.join(dimg, "msx.png"))
	elif name=="Windows":
		thumbnail = xbmc.translatePath(os.path.join(dimg, "windows.png"))		
	elif name=="SuperGrafx":
		thumbnail = xbmc.translatePath(os.path.join(dimg, "supergrafx.png"))		
