...
"""
 ...
 Author: foodbiker
 A huge thanks to enen92 for the original add-on code. (Obrigado!)
 Please ensure you register for your own API if you reuse this addon code: 
...
#youtube
channel_id = "UCYW1s3hMHEBo0KjOAm73Z8Q"
...
#youtube channel
cast = ['Seth Diamond'] #Team members / Cast of the channel. [] if none
tvshowtitle = 'Food Biker' #Name of the show
status = 'Continuing' #Status of the show
episode_playlists = ['PLdyI3_QmlZCyoDTqTTddEHsXh5ZXeEtPk'] #List of playlists to consider every integer as the episode number
