# -*- coding: utf-8 -*-
"""Kodi ListItem/artwork helpers for JazzRadio channels and Now Playing."""
...
def music_listitem(
    ...
    """Build the initial Kodi ListItem for a linear JazzRadio stream."""
    item = xbmcgui.ListItem(path=stream_url)

    tag = item.getMusicInfoTag()
    tag.setTitle(str(channel_name))
    tag.setArtist("JazzRadio")
    tag.setAlbum(f"JazzRadio — {channel_name}")
