...
class IPTVManager:
    ...
    def __init__(self, port, channelsdvr):
        """Initialize IPTV Manager object"""
        self.port        = port
        self.channelsdvr = channelsdvr
    ...
    def send_channels(self):
        ...
        return dict(version=1, streams=self.channelsdvr.buildChannels())

    @via_socket
    def send_epg(self):
        """Return JSON-EPG formatted information to IPTV Manager"""
        return dict(version=1, epg=self.channelsdvr.buildGuide())