...
class BlipTVScraper:
	...
	def searchShow(self, params = {}):
		...
		while next:
			...
			for item in dom_pages:
				name = self.common.parseDOM(item, "a")
				thumbnail = self.common.parseDOM(item, "img", {"class":"ShowPoster"}, ret = "src")
				h3 = self.common.parseDOM(item, "h3")
				link = self.common.parseDOM(h3, "a", ret = "href")
				link = link[0]
	...
	def searchEpisodes(self, params = {}):
		...
		while next == "true":
			...
			for ep in lst:
				...
				id = self.common.parseDOM(ep, "a", attrs = {"class":"EpisodeThumb" }, ret = "href")
	...
	def scrapeCategoryFeaturedShows(self, params = {}):
		...
		while tester:
			...
			for show in show_list:
				...
				id = self.common.parseDOM(h3, "a", ret = "href")
				title = self.common.parseDOM(h3, "a")
	...
	def scrapeCategoryShows(self, params = {}):
		...
		while tester:
			...
			show_list = self.common.parseDOM(result["content"], "div", { "class": "ChannelDirectoryItem"})
	...
	def scrapeShowsHomepageFeed(self, params = {}):
		...
		while tester:
			...
			for show in show_list:
				...
				h3 = self.common.parseDOM(show, "h3")
				id = self.common.parseDOM(h3[0], "a", ret ="href")
