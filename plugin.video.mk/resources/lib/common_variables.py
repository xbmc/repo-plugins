...
#youtube
channel_id = "UC4pqkS8ygCYH6GeT6W8VTMw"
youtube_api_key = "AIzaSyB4dlM5sBcCvCX33MhtXDhq_Z0pV4qpn0Q" #If you fork this addon please register another api key (https://developers.google.com/youtube/android/player/register)
#youtube channel
cast = ['Martijn'] #Team members / Cast of the channel. [] if none
tvshowtitle = 'MK' #Name of the show
status = 'Continuing' #Status of the show
episode_playlists = ['PL4yUFdgtRvccrsnnaw857blOg5SVbidY_'] #List of playlists to consider every integer as the episode number
