...
class myAddon(t1mAddon):
 ...
 def getAddonMenu(self,url,ilist):
   ...
   cats = re.compile('<div class="megaslider-holder tgtabs.+?href="(.+?)">(.+?)<',re.DOTALL).findall(html)
   cats.extend(cu)
   infoList = {}
 ...
 def getAddonVideo(self,url):
     ...
     html = self.getRequest('http://sub.toggle.sg:8080/toggle_api/v1.0/apiService/getSubtitleFilesForMedia?mediaId=%s' % vid)
