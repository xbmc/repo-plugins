...
class TestSpeakersScraper(unittest.TestCase):
    ...
    def test_get_speaker_page_count(self):
        ...
        self.assertGreaterEqual(59, count)
    ...
    def test_get_speakers_for_pages(self):
        ...
        self.assertEqual('https://tedcdnpi-a.akamaihd.net/r/tedcdnpe-a.akamaihd.net/images/ted/4a37c5ed67bf4d4a1cf7aa643607626b44aee0cc_254x191.jpg?', sample_speaker[2])
    ...
    def test_get_talks_for_speaker(self):
        ...
        self.assertEqual('https://tedcdnpi-a.akamaihd.net/r/tedcdnpe-a.akamaihd.net/images/ted/12_240x180.jpg?quality=89&amp;w=320', talk[2])
